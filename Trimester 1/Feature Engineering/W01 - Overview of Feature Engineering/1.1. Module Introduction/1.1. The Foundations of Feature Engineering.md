...
**2. Combination (e.g., Body Mass Index):** $$\mathrm{BMI} = \frac{\mathrm{Weight}_{\mathrm{kg}}}{(\mathrm{Height}_{\mathrm{m}})^2}$$
*By giving the model the $\text{BMI}$ directly, it doesn't have to struggle to figure out the relationship between Height and Weight on its own.*
