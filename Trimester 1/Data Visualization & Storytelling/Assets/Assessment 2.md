...
<img width="456" height="792" alt="image" src="https://github.com/user-attachments/assets/ca43c17e-9ee5-4722-aad1-1758c032611e" />

### **Question 1**

* **Correct Answer:** **C. Revenue Amount**
* **Eliminations:**
* *A. Customer Gender:* This is nominal data (categorical with no inherent numerical order).
...
* **Correct Answer:** **C. The slide was cluttered with multiple font sizes, too much text, misleading titles, and buried the most critical information at the bottom**
* **Eliminations:**
* *A. The engineers used an interactive reader-driven dashboard...:* The team presented using complex, static PowerPoint slides rather than interactive software dashboards.
...
* **Eliminations:**
* *B. Exceeding screen boundaries:* This is a physical layout flaw where visual elements spill off the display area.
