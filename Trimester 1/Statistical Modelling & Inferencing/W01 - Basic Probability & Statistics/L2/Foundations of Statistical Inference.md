...
A 95% confidence interval does **not** mean there is a 95% probability that the true parameter $\mu$ is in _your_ specific interval. It means that if you were to repeat the sampling process 100 times, 95 of those intervals would capture the true population mean. **The confidence is in the procedure, not the specific outcome.**
