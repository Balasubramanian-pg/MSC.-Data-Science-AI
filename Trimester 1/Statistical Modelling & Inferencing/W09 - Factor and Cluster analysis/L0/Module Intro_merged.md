...
It is common in pharmaceutical and business analytics to face "high-dimensional" data—datasets where you have hundreds of variables (e.g., patient health metrics, regional market KPIs, or survey items). Factor analysis is the primary statistical tool for identifying the "hidden" signals within this [noise](https://github.com/Balasubramanian-pg/MSC.-Data-Science-AI/blob/main/Trimester%201/Statistical%20Modelling%20%26%20Inferencing/W06 - Simple Linear Regression/L2/Testing%20for%20Significance%20in%20Regression.md#noise).
