...
Inferential statistics serves as the bridge between limited observation and generalizable knowledge. It is a mathematical discipline designed to derive rigorous conclusions about an entire **Population** by analyzing a subset, known as a **Sample**.

#### 1. The Fundamental Tension

At the heart of any statistical study lies a core tension between ambition and feasibility:

- **The Goal**: To identify a specific **Population Parameter ($\theta$)**, such as the true mean height of the entire Indian population ($\mu$).
...
The transition from a sample to the population raises critical questions regarding the validity of our conclusions:
