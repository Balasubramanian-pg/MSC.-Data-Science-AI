...
Under the **Alternative Hypothesis ($$H_a$$)**, the true difference is centered at our minimum detectable effect $$\delta$$. To achieve our target statistical power, our critical value must simultaneously sit at a distance of $$Z_{1-\beta} \text{ below } \delta$$
